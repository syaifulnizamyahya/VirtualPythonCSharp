...
# installed.
TCL_PREFIX='d:/Dev/VirtualPythonC#/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='d:/Dev/VirtualPythonC#/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='d:/Dev/VirtualPythonC#/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Id:/Dev/VirtualPythonC#/.conda\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Ld:/Dev/VirtualPythonC#/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='d:/Dev/VirtualPythonC#/.conda\Library\lib\tclstub86.lib'
